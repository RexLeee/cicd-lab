...
- `screenshots/01_actions_list_success.png` — Actions 列表頁（顯示 ✅ workflow run）
- `screenshots/02_run_detail_success.png` — workflow run 詳細頁（三個綠勾）
- `screenshots/03_test_report_summary.png` — Step Summary 顯示 dorny test-reporter 渲染的測試表格（"2 passed, 0 failed and 0 skipped"）
- `screenshots/04_artifact_junit.png` — Artifacts 區塊顯示 `junit-report` 可下載
...
📷 截圖：`screenshots/05_typecheck_failure.png`
...
📷 截圖：`screenshots/06_prettier_failure.png`
...
📷 截圖：`screenshots/07_test_failure.png`
